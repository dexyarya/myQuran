...
<template>
  <div class="mx-5 max-w-screen-xl">
    <div
      class="grid grid-cols-1 mb-4 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-4  w-full justify-content-between "
    >
      <div
        v-if="loading"
      ...
      >
        <div
          @click="openSurahDetail(items.number)"
        ...
        >
          ...
          <div class="justify-content-end">
            <h5
              class="mb-2  font-medium leading-tight text-neutral-200 dark:text-neutral-50"
            >
              {{ items.revelation }}
            </h5>
            <h5
              class="mb-2  font-medium leading-tight text-neutral-800 dark:text-neutral-50"
            >
              {{ items.numberOfAyahs }}
            </h5>
          </div>
